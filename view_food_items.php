...
<div class="container">
    <div class="container">
        ...
        <a href="view_food_items.php" class="list-group-item active">Danh sách sản phẩm</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Danh sách sản phẩm của bạn </h3>
