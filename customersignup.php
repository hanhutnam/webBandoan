<html>
<head>
    <title> Đăng ký thành viên | Nam Cafe </title>
  </head>
  ...
  <body>
    ...
    <div class="jumbotron">
     ...
     <br>
   <p>Hãy bắt đầu bằng cách tạo tài khoản nào!</p>
    </div>
    </div>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"> Đăng ký Thành viên mới </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" style="width: 400px" id="contact" type="text" name="contact" placeholder="Số điện thoại" required="">
              <!-- <span class="input-group-btn">
