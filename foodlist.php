...
<html>
  ...
  <head>
    <title> Khám phá | Ẩm thực Nam Cafe </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><!-- <span class="glyphicon glyphicon-cutlery"></span> --> Ẩm thực </a></li>
...
<form method="post" class="text-center"  action="cart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
  <div class="mypanel" style="min-height: 335px" align="center";>
    <div style="max-height: 380px"><img  src="<?php echo $row["images_path"]; ?>" class="img-responsive" ></div>
  ...
  <div>
    <h5 class="text-info container-fluid b">Số lượng: <input type="number" min="1" max="25" name="quantity" class="bg- text-center bg-dark"  value="1" style="width: 60px;"> </h5>
