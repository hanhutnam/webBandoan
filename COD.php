...
<h2 class="text-center"> Cảm ơn bạn đã đặt hàng tại Nam Cafe! Quá trình đặt hàng hiện đã hoàn tất.</h2>
...
<h3 class="text-center"> <strong>Mã đặt hàng của bạn là:</strong> <span style="color: blue;"><?php echo "$number"; ?></span> </h3>
