...
<html>
  ...
  <head>
    <title> Thanh toán online | Nam Cafe </title>
  </head>
...
<div class="container">
    <div class="row">
        <div class="jumbotron">
          ...
          <p class="text-center">Nhập chi tiết thông tin thanh toán của bạn dưới đây.</p>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <h5 class="text-muted"> Số thẻ tín dụng</h5>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 pad-adjust">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" checked class="text-muted" required=""> Lưu chi tiết để thanh toán nhanh. <a href="#">Tìm hiểu thêm</a>
                                    </label>
                                </div>
                            </div>
                        </div>
