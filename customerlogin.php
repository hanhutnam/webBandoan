...
<html>
  ...
  <head>
    <title> Đăng nhập thành viên | Nam Cafe </title>
  </head>
   ...
   <p>Vui lòng đăng nhập để tiếp tục.</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <!-- <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-user" ></label>
            </span> -->
              </span>
            </div>           
          </div>
       ...
       <label style="margin-left: 5px;"><a href="customersignup.php">Đăng ký thành viên mới.</a></label>
